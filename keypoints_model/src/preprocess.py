...
train_image_dir = DATASET_DIR / "data"/"images"/ "train" # Destination for training split images
val_image_dir   = DATASET_DIR / "data" /"images"/ "val" # Destination for val split images
